...
/**
 * Created by shenjialong on 16/6/10 01:07.
 */
public class QCommentFragment extends Fragment {


    ListView content;

    public QCommentFragment() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        View rootView = inflater.inflate(R.layout.bang_question_comment, container, false);
        content=(ListView) rootView.findViewById(R.id.bang_question_comment_lv);
